      ...
      of: [
        defineArrayMember({
          ...
          fields: [
            ...
            defineField({
              name: 'isExpandable',
              title: 'Expandable content (Deprecated)',
              type: 'boolean',
              deprecated: {
                reason: 'Resource visibility is now determined by whether Body has content.',
              },
              readOnly: true,
              hidden: true,
            ...
            defineField({
              name: 'body',
              type: 'richText',
              description: 'Leave empty to hide this resource from the website.',
            }),
          ],
