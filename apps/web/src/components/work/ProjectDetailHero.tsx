...
export default function ProjectDetailHero({
  ...
  return (
    ...
    >
      ...
      <div className="wide-screen-max wide-screen-gutter absolute inset-x-0 bottom-6 md:bottom-[clamp(3rem,9vh,6.25rem)] z-10 mx-auto w-full max-w-[1600px] px-5 md:px-8 lg:px-[6.8vw]">
        <h1
          id="project-title"
